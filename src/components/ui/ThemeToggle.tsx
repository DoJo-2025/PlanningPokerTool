...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      onClick={() => setDark((d) => !d)}
      className="relative rounded-xl p-2 text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-200"
    >
      {dark ? (
